...
call_lst = [
    {'Name': 'Company1', 'Address': '9974 Lloyd Radial Suite 005, Andrewfort, PW 45078',
     'Phone': '829-338-4124x62279',
     'Email': 'yhiggins@bishop-gentry.com', 'Website': 'https://www.griffith-diaz.org/', 'Year': 1981,
     'Employees': 2935, 'Description': 'Advanced eco-centric secured line', 'CEO': 'Amanda Hall',
     'TaxID': 8627654889,
     'call_time': 8
     },
    {'Name': 'Company2', 'Address': '7703 Craig Spurs Suite 391, Acostafurt, MT 24156', 'Phone': '225-321-1903',
     ...
     'Description': 'Sharable next generation hardware', 'CEO': 'Jacob Dunlap', 'TaxID': 2307021392,
     'call_time': 2
     },
    {'Name': 'Company3', 'Address': '5850 Stewart Club Suite 286, Carolynfurt, AR 69364',
    ...
    {'Name': 'Company5', 'Address': '141 Shannon Plaza, Janetshire, FM 18139', 'Phone': '(301)716-0789x919',
     ...
     'Description': 'Extended directional initiative', 'CEO': 'Monique Anderson', 'TaxID': 1315678326,
     'call_time': 9
     },
    {'Name': 'Company6', 'Address': '8232 Nicole Isle, New Sandra, DE 67218', 'Phone': '+1-990-955-0294x551',
     ...
     'Description': 'Automated human-resource methodology', 'CEO': 'Jessica Love', 'TaxID': 4830095509,
     'call_time': 7
     },
    {'Name': 'Company7', 'Address': '886 Barrett Street Suite 817, Laurenstad, NH 86979',
     ...
     'Year': 2022, 'Employees': 4772, 'Description': 'Persevering motivating info-mediaries',
     'CEO': 'Brittany Freeman',
     'TaxID': 6278265190, 'call_time': 1
     },
    {'Name': 'Company8', 'Address': 'USCGC Hanna, FPO AE 22431', 'Phone': '817-374-2328',
     'Email': 'tgarcia@greer.com',
     'Website': 'https://mason.com/', 'Year': 1985, 'Employees': 7270,
    ...
    {'Name': 'Company9', 'Address': '60164 Bailey Mountains, West Kaitlinside, AZ 10362',
     ...
     'Year': 1984, 'Employees': 2211, 'Description': 'Cross-group web-enabled open system',
     'CEO': 'Benjamin Sawyer', 'TaxID': 9449376713, 'call_time': 4
     },
    {'Name': 'Company10', 'Address': '178 Lewis River, New Alexander, MS 54707', 'Phone': '568.275.2394x9402',
     ...
     'Employees': 8674, 'Description': 'Up-sized incremental database', 'CEO': 'Alexandra Johnson',
     'TaxID': 2351268827, 'call_time': 6
     },
    {'Name': 'Company11', 'Address': '4709 Brooks Camp Suite 799, Port Natalie, NY 99637', 'Phone': '(818)703-8797',
     'Email': 'pamelajohnson@matthews-nelson.com', 'Website': 'https://watkins.biz/', 'Year': 1998,
     'Employees': 9951,
    ...
    {'Name': 'Company13', 'Address': '5680 Horton Trail Suite 057, Johnsontown, WI 83282',
     ...
     'Year': 2000, 'Employees': 2400, 'Description': 'Universal bi-directional leverage',
    ...
    {'Name': 'Company16', 'Address': 'USS Powers, FPO AE 79645', 'Phone': '799-737-6867',
    ...
    {'Name': 'Company17', 'Address': '21935 Roman Common Suite 870, New Erik, GU 39550',
    ...
    {'Name': 'Company18', 'Address': '5321 Sandra Flats Apt. 657, Port Timothy, IN 76963',
     'Phone': '341-610-9720x396',
     'Email': 'christopher05@adams.com', 'Website': 'https://www.coleman.com/', 'Year': 2015, 'Employees': 7697,
     'Description': 'Multi-tiered discrete projection', 'CEO': 'Brenda Wilkerson', 'TaxID': 6565717553,
     'call_time': 3
     },
    ...
    {'Name': 'Company21', 'Address': '813 Robert Way Apt. 941, South Paige, RI 03809',
    ...
    {'Name': 'Company22', 'Address': '40332 Kathryn Green, South Taylor, TN 95398',
     'Phone': '001-628-286-5262x2379',
     'Email': 'lperez@hall-jackson.biz', 'Website': 'http://jones-perez.info/', 'Year': 2020, 'Employees': 2944,
     'Description': 'Face-to-face fresh-thinking model', 'CEO': 'James Hansen', 'TaxID': 6392795545,
     'call_time': 5
     },
    {'Name': 'Company23', 'Address': '094 Kathleen Stream Apt. 125, Port Ashleyside, WV 84478',
     'Phone': '480.427.2828',
     'Email': 'april40@payne.com', 'Website': 'https://www.fitzpatrick-rasmussen.net/', 'Year': 1993,
     'Employees': 518,
     'Description': 'Implemented analyzing knowledge user', 'CEO': 'Mary Hill', 'TaxID': 5558335589,
     'call_time': 5
     },
...
async def call_company(data: dict[str, str | int]) -> str:
    data_cp = copy(data)
    await asyncio.sleep(data_cp.get('call_time'))
    return f'Company {data_cp.get("Name")}: {data_cp.get("Phone")} дозвон успешен'


async def main() -> None:
    # call_link = 'https://raw.githubusercontent.com/nefelsay/asyncio/main/call_company.py'
    # call_lst: list[dict[str, str | int]] = json.loads(
    #     requests.get(call_link).text.replace("'", '"').strip('data =')
    # )

    tasks = [asyncio.create_task(call_company(company)) for company in call_lst]
    _, pending = await asyncio.wait(tasks, timeout=5.9)
